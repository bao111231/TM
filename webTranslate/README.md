...
1. 下载编译好的版本：[webTranslate.js（v1.4.1）](https://github.com/bao111231/TM/releases/latest/download/webTranslate.js)
...
- 2026/9  v1.4.1  百度翻译接入 AI 文本翻译接口（Bearer Token 鉴权），AppID / API Key 可配置，适配 Watt Toolkit 脚本导入

## 项目地址

- 原作者（Johnny Li）：[zyufstudio/TM](https://github.com/zyufstudio/TM/tree/master/webTranslate)
- 本分支（百度AI文本翻译接口改造）：[bao111231/TM webtranslate-baiduapi](https://github.com/bao111231/TM/tree/webtranslate-baiduapi)
